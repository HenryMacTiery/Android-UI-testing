...
class MovieListFragmentTest{
    ...
    fun test_selectListItem_isDetailFragmentVisible() {
        ...
        onView(withId(R.id.recycler_view))
            .perform(actionOnItemAtPosition<MovieViewHolder>(LIST_ITEM_IN_TEST, click()))   //the actionOnItemAtPosition is specific to RecyclerView
    ...
    /**
     * select list item, nav to detailFragment, pressBack
     */
    ...
    /**
     * select list item,nav to detailFragment selectDirectors TextView, nav to DirectorsFragment
     */
    ...
    /**
     * Select list item,nav to detailFragment select Start Actors TextView, nav to StarActorsFragment
     */
    @Test
